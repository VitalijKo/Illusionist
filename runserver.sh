...
__banner__="${WHITE}\n\tWeb Server ${YELLOW}${BOLD}»»${RESET}${WHITE} part of${BLINK}${BOLD} G o d O f N e t${RESET}${WHITE} Framework ${YELLOW}${BOLD}»»${RESET}${WHITE} by ${BOLD}${CYAN}@${RED}Corruptor${RESET}\n"
